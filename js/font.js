$(document).ready(function() { 
    ...
    $(".publicNum").hover(function() {
        layer.tips(
        	'<img src="image/ljy.jpg" style="margin-top:10px" id="weChatImg"><p style="height:20px"></p><img src="image/wy.jpg" alt="" id="weChatImg"><p style="height:20px"></p><img src="image/zyb.jpg" alt="" id="weChatImg"><p style="height:20px"></p>',
        	".publicNum", {
        		tips: [4, "black"],
        		area: ["108px", "320px"]
        	})
    ...
    window.viewTeaDetail = {
        'click .viewTeach': function(e, value, row, index) {
    ...
    function newTeacher() {
        $.post('' + http_head + '/Makerspacey/Get_LectureByCheckTime.ashx?rand=' + Math.random(), {
            ...
            for (var itemValue of newInData) {
                var headImg;
    ...
    window.viewAdvDetail = {
        'click .viewAdv': function(e, value, row, index) {
            window.open("http://www.eqidd.com/changke/index_start.html?userGuid=" + row.userGuid + "&piece=1");
        }
    };
	...
	function newRecTeacher() {
	    $.post('' + http_head + '/Advisers/Get_Newadvisers.ashx?rand=' + Math.random(), {
	        ...
	        for (var itemValue of newInData5) {
	            var headImg;
    ...
    function loadNotice() {
        $.post('http://47.94.173.253:8008/ComSpace/ComSpaceVisitor/get_dynamic.ashx?rand=' + Math.random(), {
            ...
            for (var itemValue of dataNotice.items) {
...
function courseList(e, value, row, index) {
    ...
    for (let i = 0; i < courseArr.length; i++) {
        tstr = tstr + '<span>' + courseArr[i] + '</span>';
    };
