	...
	function loadNewCourse() {
		$.post('' + http_head + '/Lectures/course/Get_CourseByTime.ashx', {
			...
			for (var itemValue of dataNewCourse.items) {
				var str = '<li class="clearfix" id="' + itemValue.Id + '" style="height: 60px!important;line-height: 35px;"><p style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">' + itemValue.courseTheme +
					'</p></li>';
