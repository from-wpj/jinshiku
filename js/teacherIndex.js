$(document).ready(function() {
	...
	function searchTeacherTabel(data) {
		...
		function searchFormatter(e, value, row, index) {
			...
			if (value.headimage.indexOf(".png") > 0 || value.headimage.indexOf(".jpg") > 0 || value.headimage.indexOf(".jpeg") >
				0) {
	...
	var moneyList = ["0-501", "501-1001", "1001-1501", "1501-2001", "2001-3001", "3001-4001", "4001-5001", "5001-6001",
		"6001-7001", "7001-8001", "8001-10001", "10001-12001", "12001-15001", "15001-20001", "20001-30001", "30001-50001",
		"50001-1000000"
	]
		...
		$.post('' + http_head + '/Admin/Home/get_homeTeacher.ashx', {
			...
			for (var itemValue of dataTuijain.items) {
				...
				str = '<li class="clearfix" id="' + itemValue.lectureGuid + '" alt="' + itemValue.userName +
					...
					'" alt="" class="pull-left"><div class="pull-left"><p class="lectureName">' + itemValue.userName +
					'</p><p class="lectureLabel">' + itemValue.post + '</p></div></li>';
	...
	function activeTeacher() {
		$.post('' + http_head + '/Makerspacey/MakerArticle/Get_ActiveMaker.ashx', {
			...
			for (var itemValue of dataTuijain.items) {
				...
				str = '<li class="clearfix" id="' + itemValue.userGuid + '" alt="' + itemValue.realname +
					'"><img class="lazyac" data-original="' + imgURLmin +
					'" alt="" class="pull-left"><div class="pull-left"><p class="lectureName">' + itemValue.realname +
